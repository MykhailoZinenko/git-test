...
public class AdvancedHousing extends HabitationBuilding {
    ...
    public AdvancedHousing(HousingType housingType, Tile location) {
        ...
        // Initialize costs directly in the constructor
        ...
        // Advanced housing comes with some default amenities
    ...
    protected void calculateResourceConsumption(Map<ResourceType, Integer> output) {
        ...
        // Advanced housing consumes more resources but provides better living conditions
        ...
        // Additional consumption for amenities
    ...
    public Map<ResourceType, Integer> operate() {
        ...
        if (isActive()) {
            // Advanced housing might produce small amounts of research
            if (housingType == HousingType.RESEARCH_QUARTERS) {
                output.put(ResourceType.RESEARCH, 2 + occupied / 5); // Base + bonus based on occupants
            }
        }
