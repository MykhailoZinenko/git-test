...
public class BuildingSelectionOverlay extends StackPane {
    ...
    public BuildingSelectionOverlay(Tile tile) {
        ...
        // Main content container with app styling
        ...
        // Add container to overlay with initial animation setup
        ...
        // Update build button when building is selected
        eventBus.subscribe(BuildingSelectedEvent.class, event -> {
    ...
    private void createProductionBuildingsTab() {
        ...
        // Section header for resource producers
        ...
        // Vertical list for resource producers
        ...
        // Section header for advanced producers
        ...
        // Vertical list for advanced producers
    ...
    private void createHabitationBuildingsTab() {
        ...
        // Section header for basic housing
        ...
        // Vertical list for basic housing
        ...
        // Section header for advanced housing
        ...
        // Vertical list for advanced housing
    ...
    private void updateDetailsSection() {
        ...
        // Additional details depending on building type
        ...
        // Warning label if not enough resources
    ...
    private void buildSelectedBuilding() {
        ...
        if (result.isSuccess()) {
            ...
            // Publish event to update the tile view
            eventBus.publish(new TileEvents.TileUpdatedEvent(tile));

            // Show success message after returning to gameplay
            Runnable showSuccessMessage = () -> {
                ...
                // Delay showing the message to avoid UI confusion
                new Thread(() -> {
                    try {
                        Thread.sleep(500);
    ...
    private class BuildingOptionButton extends HBox {
        ...
        public BuildingOptionButton(String name, String description, BuildingSupplier supplier) {
            ...
            // Left side - Building name and description
            ...
            // Add some basic building info to the right
